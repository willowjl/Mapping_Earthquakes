...
// Add layer for all earthquake data.
let allEarthquakes = new L.LayerGroup();

// Add layer for tectonic plate data.
let plates = new L.LayerGroup();

// Add layer for major earthquake data.
let majorEarthquakes = new L.LayerGroup();

// Add a reference to the earthquakes, tectonic plates, and major earthquakes group to the overlays object.
let overlays = {
...
// Tectonic Plates
  ...
  L.geoJson(data, {
    // We set the style for the lines using our variable
  style: myStyle,
